...
(function() {
  function async_load(){
    ...
    ex_learn.src = "https://learn.extension.org/widgets/events.js?widget_key=<?php echo $a['key'] ?>&limit=<?php echo $a['limit'] ?>&tags=<?php echo $meta_value ?>&operator=<?php echo $a['operator'] ?>";
